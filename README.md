## @f1stnpm3/neque-blanditiis-sapiente &mdash; object viewer &nbsp; &nbsp; [![npm](https://img.shields.io/npm/v/@f1stnpm3/neque-blanditiis-sapiente.svg)](https://www.npmjs.com/package/@f1stnpm3/neque-blanditiis-sapiente) [![build status](https://github.com/f1stnpm3/neque-blanditiis-sapiente/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/f1stnpm3/neque-blanditiis-sapiente/actions/workflows/ci.yml)

**@f1stnpm3/neque-blanditiis-sapiente** &mdash; pronounced *vúed* or *vue dd* &mdash;  is a Vue 3 object viewer for displaying complex JavaScript objects, Vue Reactive and Ref objects, Functions, Maps, Sets, Symbols and all JavaScript Primitives in order to monitor their changes **live** with full reactivity. Inspired by the Laravels **dd()** debugging function.
...
```js
import { VueDd } from '@f1stnpm3/neque-blanditiis-sapiente'
...
```bash
# npm
npm install @f1stnpm3/neque-blanditiis-sapiente
# yarn
yarn add @f1stnpm3/neque-blanditiis-sapiente
```
...
```html
<@f1stnpm3/neque-blanditiis-sapiente v-model="object" />
```
...
- performance optimized, even large objects like `window` can be @f1stnpm3/neque-blanditiis-sapiente
...
| open   | `(setup) => {...}` | `{ open, pointer, level } = setup`                                             | On open by @f1stnpm3/neque-blanditiis-sapiente itself or by a user, this emit will be called |
...
- There are many things that can be done with this package, for ex. here is what I am doing with it right now:
    ...
    - All of these features area currently in development in **XRay** component, that will soon be part of **@f1stnpm3/neque-blanditiis-sapiente**, but feel free to develop your own versions with this package
...
Versions up to **@f1stnpm3/neque-blanditiis-sapiente@1.1.6** supported **Vue 2.7.5** and above, but import of the package is different from Vue 3. In Vue 2 @f1stnpm3/neque-blanditiis-sapiente is imported as default and not as a destructured `VueDd`
```js
// to install @f1stnpm3/neque-blanditiis-sapiente with Vue 2 support
// yarn add @f1stnpm3/neque-blanditiis-sapiente@1.1.6
// npm install @f1stnpm3/neque-blanditiis-sapiente@1.1.6
// note: 'import VueDd...', and not 'import { VueDd }...'
import VueDd from '@f1stnpm3/neque-blanditiis-sapiente'
```
Also note in Vue 2, you have to use `:model-value` instead of `v-model`
```html
<@f1stnpm3/neque-blanditiis-sapiente :model-value="obj" />
```
> Note that Vue 2 version cannot support large objects like `window`. For some reason, it reaches a stack size limit and breaks. It is a known issue in Vue 2, that's why migrate to Vue 3 ASAP in order to use the full power of **@f1stnpm3/neque-blanditiis-sapiente**
## Credits & Thanks
...
> **Highlight.js** is built into @f1stnpm3/neque-blanditiis-sapiente to provide JavaScript function highlighting.
